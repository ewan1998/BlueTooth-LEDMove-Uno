...
CPP_SRCS += \
C:\opt\Sloeber\arduinoPlugin\libraries\PrintEx\1.2.0\src\tools\CRCStream\CRCStream.cpp 

LINK_OBJ += \
.\libraries\PrintEx\src\tools\CRCStream\CRCStream.cpp.o 

CPP_DEPS += \
.\libraries\PrintEx\src\tools\CRCStream\CRCStream.cpp.d 


# Each subdirectory must supply rules for building sources it contributes
libraries\PrintEx\src\tools\CRCStream\CRCStream.cpp.o: C:\opt\Sloeber\arduinoPlugin\libraries\PrintEx\1.2.0\src\tools\CRCStream\CRCStream.cpp
	@echo 'Building file: $<'
